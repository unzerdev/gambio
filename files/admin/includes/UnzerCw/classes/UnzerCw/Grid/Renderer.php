...
class UnzerCw_Grid_Renderer extends Customweb_Grid_Renderer {
	...
	public function getTableCssClass() {
		return 'table table-striped table-condensed table-hover table-bordered panel';
	}
	...
	public function getInfoPattern() {
		return unzercw_translate('Showing !startingItem to !endingItem of !totalItems items.');
	}
	
	public function getSubmitButtonLabel() {
		return unzercw_translate('Apply');
	}
