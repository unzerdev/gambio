...
class UnzerCw_Adapter_WidgetAdapter extends UnzerCw_Adapter_AbstractAdapter
{
	...
	private function doRedirection($formData,  UnzerCw_PaymentMethod $paymentMethod) {
		...
		return UnzerCw_Util::getFrontendUrl('unzercw_widget.php', $params, true);
	...
	public function getPaymentPageContent(UnzerCw_Entity_Transaction $dbTransaction, $aliasTransaction, $failedTransaction) {
		...
		return array(
			...
			'formAction' =>  UnzerCw_Util::getFrontendUrl('unzercw_widget.php', array('cw_transaction_id' => $dbTransaction->getTransactionId()), true),
		);
	}
