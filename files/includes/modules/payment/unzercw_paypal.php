...
if ((!isset($GLOBALS['unzercw_paypal_loaded_class']) || $GLOBALS['unzercw_paypal_loaded_class'] !== true ) && !class_exists('unzercw_paypal')) {
	$GLOBALS['unzercw_paypal_loaded_class'] = true;
	...
	if (!class_exists('unzercw_paypal') && !in_array('unzercw_paypal', get_declared_classes())) {
		...
		'AED' => array(
 		...
 		'ZWL' => array(
			...
			protected function getImageUrl() {
				return 'images/icons_unzercw/paypal.png';
			}
		}
	}
