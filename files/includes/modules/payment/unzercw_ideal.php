...
if ((!isset($GLOBALS['unzercw_ideal_loaded_class']) || $GLOBALS['unzercw_ideal_loaded_class'] !== true ) && !class_exists('unzercw_ideal')) {
	$GLOBALS['unzercw_ideal_loaded_class'] = true;
	...
	if (!class_exists('unzercw_ideal') && !in_array('unzercw_ideal', get_declared_classes())) {
		...
		'AED' => array(
 		...
 		'ZWL' => array(
			...
			protected function getImageUrl() {
				return 'images/icons_unzercw/ideal.png';
			}
		}
	}
