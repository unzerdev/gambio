...
if ((!isset($GLOBALS['unzercw_alipay_loaded_class']) || $GLOBALS['unzercw_alipay_loaded_class'] !== true ) && !class_exists('unzercw_alipay')) {
	$GLOBALS['unzercw_alipay_loaded_class'] = true;
	...
	if (!class_exists('unzercw_alipay') && !in_array('unzercw_alipay', get_declared_classes())) {
		...
		'AED' => array(
 		...
 		'ZWL' => array(
			...
			protected function getImageUrl() {
				return 'images/icons_unzercw/alipay.png';
			}
		}
	}
