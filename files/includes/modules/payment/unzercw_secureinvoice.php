...
if ((!isset($GLOBALS['unzercw_secureinvoice_loaded_class']) || $GLOBALS['unzercw_secureinvoice_loaded_class'] !== true ) && !class_exists('unzercw_secureinvoice')) {
	$GLOBALS['unzercw_secureinvoice_loaded_class'] = true;
	...
	if (!class_exists('unzercw_secureinvoice') && !in_array('unzercw_secureinvoice', get_declared_classes())) {
		...
		'AED' => array(
 		...
 		'ZWL' => array(
			...
			protected function getImageUrl() {
				return 'images/icons_unzercw/secureinvoice.png';
			}
		}
	}
