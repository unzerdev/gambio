...
if ((!isset($GLOBALS['unzercw_securesepa_loaded_class']) || $GLOBALS['unzercw_securesepa_loaded_class'] !== true ) && !class_exists('unzercw_securesepa')) {
	$GLOBALS['unzercw_securesepa_loaded_class'] = true;
	...
	if (!class_exists('unzercw_securesepa') && !in_array('unzercw_securesepa', get_declared_classes())) {
		...
		'AED' => array(
 		...
 		'ZWL' => array(
			...
			protected function getImageUrl() {
				return 'images/icons_unzercw/securesepa.png';
			}
		}
	}
