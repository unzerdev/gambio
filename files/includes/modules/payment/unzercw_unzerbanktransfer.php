...
if ((!isset($GLOBALS['unzercw_unzerbanktransfer_loaded_class']) || $GLOBALS['unzercw_unzerbanktransfer_loaded_class'] !== true ) && !class_exists('unzercw_unzerbanktransfer')) {
	$GLOBALS['unzercw_unzerbanktransfer_loaded_class'] = true;
	...
	if (!class_exists('unzercw_unzerbanktransfer') && !in_array('unzercw_unzerbanktransfer', get_declared_classes())) {
		...
		'AED' => array(
 		...
 		'ZWL' => array(
			...
			protected function getImageUrl() {
				return 'images/icons_unzercw/unzerbanktransfer.png';
			}
		}
	}
