...
if ((!isset($GLOBALS['unzercw_unzerinstallment_loaded_class']) || $GLOBALS['unzercw_unzerinstallment_loaded_class'] !== true ) && !class_exists('unzercw_unzerinstallment')) {
	$GLOBALS['unzercw_unzerinstallment_loaded_class'] = true;
	...
	if (!class_exists('unzercw_unzerinstallment') && !in_array('unzercw_unzerinstallment', get_declared_classes())) {
		...
		'AED' => array(
 		...
 		'ZWL' => array(
			...
			'effective_interest_rate' => array(
				'title' => unzercw_translate("Applied Interest Rate"),
 				'description' => unzercw_translate("The interest rate in percent that you enter here will be applied onto the instalment. The rate must be above the amount that you have agreed up on with Unzer."),
 				'type' => 'TEXTFIELD',
 				'default' => '5.99',
 			),
			...
			protected function getImageUrl() {
				return 'images/icons_unzercw/unzerinstallment.png';
			}
		}
	}
