...
if ((!isset($GLOBALS['unzercw_giropay_loaded_class']) || $GLOBALS['unzercw_giropay_loaded_class'] !== true ) && !class_exists('unzercw_giropay')) {
	$GLOBALS['unzercw_giropay_loaded_class'] = true;
	...
	if (!class_exists('unzercw_giropay') && !in_array('unzercw_giropay', get_declared_classes())) {
		...
		'AED' => array(
 		...
 		'ZWL' => array(
			...
			protected function getImageUrl() {
				return 'images/icons_unzercw/giropay.png';
			}
		}
	}
