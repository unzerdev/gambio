...
if ((!isset($GLOBALS['unzercw_creditcard_loaded_class']) || $GLOBALS['unzercw_creditcard_loaded_class'] !== true ) && !class_exists('unzercw_creditcard')) {
	$GLOBALS['unzercw_creditcard_loaded_class'] = true;
	...
	if (!class_exists('unzercw_creditcard') && !in_array('unzercw_creditcard', get_declared_classes())) {
		...
		'AED' => array(
 		...
 		'ZWL' => array(
			...
			'placeholder_size' => array(
				'title' => unzercw_translate("Element Size"),
 				'description' => unzercw_translate("How should elements from Unzer be loaded? With narrow elements the element label is displayed by the store, with wide elements it is loaded via javascript by Unzer. The input elements are always loaded from Unzer."),
 				'type' => 'SELECT',
 				'options' => array(
					'wide' => unzercw_translate("Wide (label from Unzer)"),
 					'narrow' => unzercw_translate("Narrow (label from shop)"),
 				),
 				'default' => 'narrow',
 			),
 			'send_basket' => array(
 			...
 			'capturing' => array(
				'title' => unzercw_translate("Capturing"),
 				'description' => unzercw_translate("Should the amount be captured automatically after the order (Direct Charge) or should the amount only be reserved (Authorize)?"),
 				'type' => 'SELECT',
 				'options' => array(
					'direct' => unzercw_translate("Direct Charge"),
 					'deferred' => unzercw_translate("Authorize"),
 				),
 				'default' => 'direct',
 			),
			...
			protected function getImageUrl() {
				return 'images/icons_unzercw/creditcard.png';
			}
		}
	}
