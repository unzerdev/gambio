...
if ((!isset($GLOBALS['unzercw_prepayment_loaded_class']) || $GLOBALS['unzercw_prepayment_loaded_class'] !== true ) && !class_exists('unzercw_prepayment')) {
	$GLOBALS['unzercw_prepayment_loaded_class'] = true;
	...
	if (!class_exists('unzercw_prepayment') && !in_array('unzercw_prepayment', get_declared_classes())) {
		...
		'AED' => array(
 		...
 		'ZWL' => array(
			...
			protected function getImageUrl() {
				return 'images/icons_unzercw/prepayment.png';
			}
		}
	}
