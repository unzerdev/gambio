...
if ((!isset($GLOBALS['unzercw_eps_loaded_class']) || $GLOBALS['unzercw_eps_loaded_class'] !== true ) && !class_exists('unzercw_eps')) {
	$GLOBALS['unzercw_eps_loaded_class'] = true;
	...
	if (!class_exists('unzercw_eps') && !in_array('unzercw_eps', get_declared_classes())) {
		...
		'AED' => array(
 		...
 		'ZWL' => array(
			...
			protected function getImageUrl() {
				return 'images/icons_unzercw/eps.png';
			}
		}
	}
