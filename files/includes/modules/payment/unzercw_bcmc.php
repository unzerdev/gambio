...
if ((!isset($GLOBALS['unzercw_bcmc_loaded_class']) || $GLOBALS['unzercw_bcmc_loaded_class'] !== true ) && !class_exists('unzercw_bcmc')) {
	$GLOBALS['unzercw_bcmc_loaded_class'] = true;
	...
	if (!class_exists('unzercw_bcmc') && !in_array('unzercw_bcmc', get_declared_classes())) {
		...
		'AED' => array(
 		...
 		'ZWL' => array(
			...
			protected function getImageUrl() {
				return 'images/icons_unzercw/bcmc.png';
			}
		}
	}
