...
if ((!isset($GLOBALS['unzercw_przelewy24_loaded_class']) || $GLOBALS['unzercw_przelewy24_loaded_class'] !== true ) && !class_exists('unzercw_przelewy24')) {
	$GLOBALS['unzercw_przelewy24_loaded_class'] = true;
	...
	if (!class_exists('unzercw_przelewy24') && !in_array('unzercw_przelewy24', get_declared_classes())) {
		...
		'AED' => array(
 		...
 		'ZWL' => array(
			...
			protected function getImageUrl() {
				return 'images/icons_unzercw/przelewy24.png';
			}
		}
	}
