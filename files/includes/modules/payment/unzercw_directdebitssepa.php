...
if ((!isset($GLOBALS['unzercw_directdebitssepa_loaded_class']) || $GLOBALS['unzercw_directdebitssepa_loaded_class'] !== true ) && !class_exists('unzercw_directdebitssepa')) {
	$GLOBALS['unzercw_directdebitssepa_loaded_class'] = true;
	...
	if (!class_exists('unzercw_directdebitssepa') && !in_array('unzercw_directdebitssepa', get_declared_classes())) {
		...
		'AED' => array(
 		...
 		'ZWL' => array(
			...
			'status_authorized' => array(
 			...
 			'merchant_name' => array(
				'title' => unzercw_translate("Merchant name"),
 				'description' => unzercw_translate("Here you can configure the merchant name which is displayed as part of the mandate text."),
 				'type' => 'TEXTFIELD',
 				'default' => '',
 			),
			...
			protected function getImageUrl() {
				return 'images/icons_unzercw/directdebitssepa.png';
			}
		}
	}
