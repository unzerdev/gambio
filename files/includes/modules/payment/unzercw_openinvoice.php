...
if ((!isset($GLOBALS['unzercw_openinvoice_loaded_class']) || $GLOBALS['unzercw_openinvoice_loaded_class'] !== true ) && !class_exists('unzercw_openinvoice')) {
	$GLOBALS['unzercw_openinvoice_loaded_class'] = true;
	...
	if (!class_exists('unzercw_openinvoice') && !in_array('unzercw_openinvoice', get_declared_classes())) {
		...
		'AED' => array(
 		...
 		'ZWL' => array(
			...
			protected function getImageUrl() {
				return 'images/icons_unzercw/openinvoice.png';
			}
		}
	}
