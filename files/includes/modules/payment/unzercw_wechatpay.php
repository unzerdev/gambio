...
if ((!isset($GLOBALS['unzercw_wechatpay_loaded_class']) || $GLOBALS['unzercw_wechatpay_loaded_class'] !== true ) && !class_exists('unzercw_wechatpay')) {
	$GLOBALS['unzercw_wechatpay_loaded_class'] = true;
	...
	if (!class_exists('unzercw_wechatpay') && !in_array('unzercw_wechatpay', get_declared_classes())) {
		...
		'AED' => array(
 		...
 		'ZWL' => array(
			...
			protected function getImageUrl() {
				return 'images/icons_unzercw/wechatpay.png';
			}
		}
	}
