 ...
 *
 */
if (!class_exists('unzercw_SendOrderThemeContentView', false)) {
    $baseAdminPath = defined('DIR_ADMIN') ? DIR_ADMIN : 'admin/';
    require_once dirname(dirname(dirname(dirname(dirname(dirname(dirname(__FILE__))))))) . '/' . $baseAdminPath . 'includes/UnzerCw/init.php';
    require_once 'UnzerCw/Util.php';

    /**
	 * Set payment information in order confirmation email
	 */
	class unzercw_SendOrderThemeContentView extends unzercw_SendOrderThemeContentView_parent {
