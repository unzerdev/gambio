...
$widgetHtml = $adapter->getWidgetHtml($dbTransaction->getTransactionObject(), UnzerCw_HttpRequest::getInstance()->getParameters());
...
$contentUnzerCw .= '<div class="unzercw-widget">' . $widgetHtml . '</div>';
